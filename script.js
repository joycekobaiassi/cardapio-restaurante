...
@@ -156,6 +53,7 @@ const bebidas = document.getElementById("bebidas");
let carrinho = [];
let total = 0;
...
@@ -166,79 +64,28 @@ produtos.forEach((produto, index) => {
...
@@ -260,6 +107,8 @@ function limparCarrinho() {
  atualizarCarrinho();
}
...
@@ -287,26 +136,24 @@ function finalizarPedido() {
      lonRestaurante
    );
...
@@ -329,101 +176,9 @@ function finalizarPedido() {
...
function calcularDistancia(lat1, lon1, lat2, lon2) {
  const R = 6371;
@@ -440,24 +195,3 @@ function calcularDistancia(lat1, lon1, lat2, lon2) {
